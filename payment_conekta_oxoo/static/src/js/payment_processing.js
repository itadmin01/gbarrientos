odoo.define('payment.processing', function (require) {
    ...
    return Widget.extend({
        ...
        processPolledData: function (transactions) {
			...
			if (transactions.length > 0 && (transactions[0].acquirer_provider == 'transfer' || transactions[0].acquirer_provider == 'conekta_oxxo')) {
            ...
            if(countTxInState(['tx_cancel','tx_done', 'tx_error', 'tx_pending', 'tx_authorized']) === 1) {
