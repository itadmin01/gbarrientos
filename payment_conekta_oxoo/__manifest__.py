# -*- coding: utf-8 -*-
{
    'name': "Conekta Payment Acquirer",
    'summary': """Payment Acquirer: Conekta / OXOO Cash Payment""",
...
Conekta Payment Acquirer, konekta, conecta, konecta, konekta
This module depends on External dependensies of Conekta. To install this dependency run on you system
pip3 install conekta
    """,
    'author': "Nilesh Sheliya",
    "live_test_url": "https://odoo.sheliyainfotech.com/contactus?description=demo:payment_conekta_oxoo&odoo_version=12.0",
    'category': 'Accounting',
    'version': '1.0',
    ...
    "price": 189.00,
    "currency": "EUR",
    "website": "https://apps.odoo.com/apps/modules/12.0/payment_conekta_oxoo/",
    'data': [
...
#https://developers.conekta.com/tutorials/oxxopay?language=python
#https://developers.conekta.com/tutorials